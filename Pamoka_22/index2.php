                                        ...
                                        <div class="text-start">
                                            ...
                                            echo '</pre>';
                                                        ...
                                                        <table class="table">
                                                         ...
                                                         <?php
                                                            $discount = 0;
                                                            if (($_GET['kuponas'] <> "") and (array_search($_GET['kuponas'], array_column($kuponai, 'kuponas')))) {
                                                            $id = array_search($_GET['kuponas'], array_column($kuponai, 'kuponas'));
                                                            echo '
                                                             <div class="alert alert-success" role="alert">
                                                                    Kuponas galiojantis, jums taikoma '.$kuponai[$id]['discount'].'% nuplaida!
                                                             </div>
                                                             ';
                                                            if (is_numeric($kuponai[$id]['discount'])) {
                                                                 $discount= ($suma*$kuponai[$id]['discount'])/100;
                                                            }
                                                         } else {
                                ...
                                <div class="col-lg-12">
                                        <form method="GET" action="">
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-2" >
                                                        <button type="submit" class="btn btn-success">Pritaikyti nuolaidą</button>
                                                    </div>
